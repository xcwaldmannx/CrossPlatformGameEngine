...
namespace ascen
{
	...
	public:
		...
		void create() override
		{
			...
			QueueFamilies::updateQueueFamilies(mPhysicalDevice, mSurface, mGraphicsFamily, mPresentFamily);
			...
			mCommandPool = std::make_shared<CommandPool>(mGraphicsFamily.value());
		...
		void destroy() override
		{
			...
			Texture::destroy(mDevice, *mDepthTexture);
		...
		void resize() override
		{
			...
			mDepthTexture = std::make_shared<Texture>(
				Texture::create(
					mPhysicalDevice,
					mDevice,
					QueueFamilies::getDeviceQueue(mDevice, mGraphicsFamily.value()),
					mCommandPool,
					PhysicalDevice::findDepthFormat(mPhysicalDevice),
