...
{
public:
	RenderSystem(const std::unordered_map<std::string, MyModel>& models);
	...
	const std::vector<ascen::IndirectBuffer::IndexedIndirectCommand> getMeshDraws() const;
	const std::vector<ascen::IndirectBuffer::IndirectCommand> getBBoxDraws() const;
...
private:
	...
	std::vector<ascen::IndirectBuffer::IndexedIndirectCommand> mMeshDraws;
	std::vector<ascen::IndirectBuffer::IndirectCommand> mBBoxDraws;
